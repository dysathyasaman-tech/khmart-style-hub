            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@khmart.com</p>
                  <p className="text-gray-600">sales@khmart.com</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                ...
                You can also track your order in the "My Account" section.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                ...
                Returns are free and easy through our returns portal.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Currently, we only ship within Cambodia. We're working on expanding 
                our shipping options to serve customers internationally.
              </p>
            </div>

            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">How do I change or cancel my order?</h3>
              <p className="text-gray-600">
                You can modify or cancel your order within 2 hours of placing it. 
